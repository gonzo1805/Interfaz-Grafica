package cr.ac.ucr.ecci.ci1221.FatPusheen.util.collections.map;
 ...
 */
public class LinkedMap<K, V> implements Map<K, V>, Iterable<K> {
	...
	private class It<K> implements Iterator<K> {
